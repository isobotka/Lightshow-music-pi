...
_PLAYLIST_PATH = "/somepath"

ser = serial.Serial('/dev/ttyACM0',9600)

def setColor(r, color):
	r3 = r%10
	r //= 10
	r2 = r%10
	r //= 10
...
def display_column(col=0,height=0.0,color=None):
	global c
	global columns
    ...
    ##Change here to add my pi support
	if col == 1:			
		setColor(int(height*255),'r')
		
	elif col == 2:
		setColor(int(height*255),'g')
        
	elif col == 3:
		setColor(int(height*255),'b')
...
def main():
   ...
   # hc.initialize()
    ...
    song_filename = song_filename.replace("$SYNCHRONIZED_LIGHTS_HOME", '/home/pi/lightshowpi')
